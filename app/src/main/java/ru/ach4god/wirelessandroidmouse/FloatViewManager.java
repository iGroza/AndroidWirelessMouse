        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            switch (event.getActionMasked()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    Log.d("rawXY",event.getRawX() + " | " + event.getRawY() );
                    int deltaX = (int) event.getRawX() - mFloatViewLastX;
                    int deltaY = (int) event.getRawY() - mFloatViewLastY;
                    Log.d("deltaXY",deltaX + " | " + deltaY );
                    mFloatViewLastX = (int) event.getRawX();
                    mFloatViewLastY = (int) event.getRawY();
                    Log.d("mFloatViewLastXY",mFloatViewLastX + " | " + mFloatViewLastY );
                    Log.d("mFloatViewFirstXY",mFloatViewFirstX + " | " + mFloatViewFirstY );
